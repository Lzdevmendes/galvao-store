...
const CSP = [
  ...
  "connect-src 'self' https://*.supabase.co https://api.mercadopago.com https://*.upstash.io https://www.google-analytics.com https://region1.analytics.google.com https://www.clarity.ms wss://*.supabase.co https://*.ingest.sentry.io https://*.ingest.us.sentry.io https://viacep.com.br",
