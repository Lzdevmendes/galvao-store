              ...
              <div style={{ display: "flex", gap: 8 }}>
                {process.env.NEXT_PUBLIC_INSTAGRAM && (
                  <a
                    ...
                    style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 36, height: 36, borderRadius: 8, background: "var(--ink-800)", color: "var(--ink-300)", textDecoration: "none", transition: "color .15s" }}
                  >
