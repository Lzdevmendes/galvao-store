  ...
  return (
    <>
      ...
      >
        ...
        {/* Zoom hint */}
        {!zoomed && (
          <div style={{ position: 'absolute', bottom: 12, right: 12, background: 'rgba(0,0,0,.5)', color: '#fff', borderRadius: 6, padding: '4px 8px', fontSize: 11, fontFamily: 'var(--font-ui)', backdropFilter: 'blur(4px)' }}>
            🔍 Zoom
          </div>
        )}
