...
export default function ContatoPage() {
  ...
  return (
    <div className="container" style={{ paddingTop: 48, paddingBottom: 96, maxWidth: 700 }}>
      {/* Hover por CSS (Server Component não pode passar event handlers) */}
      <style>{`.contact-card:hover{border-color:var(--card-color)!important;transform:translateY(-2px)}`}</style>
